...
for (var timelinechart, optionsYears, chartYears, areachartBasicColors = getChartColorsArray("area_chart_basic"), areachartSplineColors = (areachartBasicColors && (options = {
    series: [{
        name: "STOCK ABC",
...
}, (chart = new ApexCharts(document.querySelector("#area_chart_basic"), options)).render()), getChartColorsArray("area_chart_spline")), areachartDatetimeColors = (areachartSplineColors && (options = {
    series: [{
        name: "Expenses",
        data: [31, 40, 28, 51, 42, 109, 100]
    }, {name: "Income", data: [11, 32, 45, 32, 34, 52, 41]}],
...
}, (chart = new ApexCharts(document.querySelector("#area_chart_spline"), options)).render()), getChartColorsArray("area_chart_datetime")), resetCssClasses = (areachartDatetimeColors && (timelinechart = {
    series: [{
    ...
    chart: {id: "area-datetime", type: "area", height: 320, zoom: {autoScaleYaxis: !0}, toolbar: {show: !1}},
    colors: areachartDatetimeColors,
    annotations: {
        yaxis: [{
            y: 30,
            borderColor: "#999",
            label: {show: !0, text: "Support", style: {color: "#fff", background: "#e83e8c"}}
        }],
        xaxis: [{
            x: new Date("14 Nov 2012").getTime(),
            borderColor: "#999",
            yAxisIndex: 0,
            label: {show: !0, text: "Rally", style: {color: "#fff", background: "#564ab1"}}
        }]
    },
    dataLabels: {enabled: !1},
...
}, (timelinechart = new ApexCharts(document.querySelector("#area_chart_datetime"), timelinechart)).render()), function (e) {
    var t = document.querySelectorAll(".timeline");
    Array.prototype.forEach.call(t, function (e) {
        e.classList.remove("active")
    }), e.target.classList.add("active")
}), areachartNegativeColors = (document.querySelector("#one_month").addEventListener("click", function (e) {
    resetCssClasses(e), timelinechart.zoomX(new Date("28 Jan 2013").getTime(), new Date("27 Feb 2013").getTime())
}), document.querySelector("#six_months").addEventListener("click", function (e) {
    resetCssClasses(e), timelinechart.zoomX(new Date("27 Sep 2012").getTime(), new Date("27 Feb 2013").getTime())
}), document.querySelector("#one_year").addEventListener("click", function (e) {
    resetCssClasses(e), timelinechart.zoomX(new Date("27 Feb 2012").getTime(), new Date("27 Feb 2013").getTime())
}), document.querySelector("#all").addEventListener("click", function (e) {
    resetCssClasses(e), timelinechart.zoomX(new Date("23 Jan 2012").getTime(), new Date("27 Feb 2013").getTime())
}), getChartColorsArray("area_chart_negative")), areachartMonthsColors = (areachartNegativeColors && (options = {
    series: [{
        name: "North",
        data: [{x: 1996, y: 322}, {x: 1997, y: 324}, {x: 1998, y: 329}, {x: 1999, y: 342}, {x: 2e3, y: 348}, {
            x: 2001,
            y: 334
        }, {x: 2002, y: 325}, {x: 2003, y: 316}, {x: 2004, y: 318}, {x: 2005, y: 330}, {x: 2006, y: 355}, {
            x: 2007,
            y: 366
        }, {x: 2008, y: 337}, {x: 2009, y: 352}, {x: 2010, y: 377}, {x: 2011, y: 383}, {x: 2012, y: 344}, {
            x: 2013,
            y: 366
        }, {x: 2014, y: 389}, {x: 2015, y: 334}]
    }, {
        name: "South",
        data: [{x: 1996, y: 162}, {x: 1997, y: 90}, {x: 1998, y: 50}, {x: 1999, y: 77}, {x: 2e3, y: 35}, {
            x: 2001,
            y: -45
        }, {x: 2002, y: -88}, {x: 2003, y: -120}, {x: 2004, y: -156}, {x: 2005, y: -123}, {x: 2006, y: -88}, {
            x: 2007,
            y: -66
        }, {x: 2008, y: -45}, {x: 2009, y: -29}, {x: 2010, y: -45}, {x: 2011, y: -88}, {x: 2012, y: -132}, {
            x: 2013,
            y: -146
        }, {x: 2014, y: -169}, {x: 2015, y: -184}]
    }],
    chart: {type: "area", height: 350, toolbar: {show: !1}},
    dataLabels: {enabled: !1},
    stroke: {curve: "straight"},
    title: {text: "Area with Negative Values", align: "left", style: {fontSize: "14px", fontWeight: 500}},
    xaxis: {type: "datetime", axisBorder: {show: !1}, axisTicks: {show: !1}},
    colors: areachartNegativeColors,
    yaxis: {
        tickAmount: 4,
        floating: !1,
        labels: {style: {colors: "#038edc"}, offsetY: -7, offsetX: 0},
        axisBorder: {show: !1},
        axisTicks: {show: !1}
    },
    fill: {opacity: .5},
    tooltip: {x: {format: "yyyy"}, fixed: {enabled: !1, position: "topRight"}},
    grid: {yaxis: {lines: {offsetX: -30}}, padding: {left: 20}}
}, (chart = new ApexCharts(document.querySelector("#area_chart_negative"), options)).render()), getChartColorsArray("area_chart-months")), areachartyearsColors = (areachartMonthsColors && (options = {
    series: [{
        name: "commits",
    ...
    chart: {
        ...
        events: {
            mounted: function (e) {
                var t = document.querySelector(".cmeta span.commits"),
                    e = e.getSeriesTotalXRange(e.w.globals.minX, e.w.globals.maxX);
                t.innerHTML = e
            }, updated: function (e) {
                var t = document.querySelector(".cmeta span.commits"),
                    e = e.getSeriesTotalXRange(e.w.globals.minX, e.w.globals.maxX);
    ...
    yaxis: {show: !1, tickAmount: 3},
    xaxis: {type: "datetime"}
}, (chart = new ApexCharts(document.querySelector("#area_chart-months"), options)).render()), getChartColorsArray("area_chart-years")), generateDayWiseTimeSeries = (areachartyearsColors && (optionsYears = {
    series: [{
        name: "commits",
        data: githubdata.series
    }],
    chart: {
        ...
        selection: {
            enabled: !0,
            xaxis: {min: new Date("26 Jan 2014").getTime(), max: new Date("29 Mar 2015").getTime()}
        }
    },
    ...
    xaxis: {type: "datetime"}
}, (chartYears = new ApexCharts(document.querySelector("#area_chart-years"), optionsYears)).render()), function (e, t, a) {
    for (var r = 0, o = []; r < t;) {
        var s = e, i = Math.floor(Math.random() * (a.max - a.min + 1)) + a.min;
        o.push([s, i]), e += 864e5, r++
    }
    return o
}), areachartstackedColors = getChartColorsArray("area_chart_stacked"), ts1 = (areachartstackedColors && (options = {
    series: [{
        name: "South",
    ...
    chart: {
        type: "area", height: 350, stacked: !0, toolbar: {show: !1}, events: {
    ...
    legend: {position: "top", horizontalAlign: "left"},
    xaxis: {type: "datetime"}
}, (chart = new ApexCharts(document.querySelector("#area_chart_stacked"), options)).render()), 13885344e5), ts2 = 13886208e5, ts3 = 13890528e5, dataSet = [[], [], []], i = 0; i < 12; i++) {
...
var options, chart, areachartirregularColors = getChartColorsArray("area_chart_irregular");
areachartirregularColors && (options = {
    series: [{name: "PRODUCT A", data: dataSet[0]}, {
        name: "PRODUCT B",
        data: dataSet[1]
    }, {name: "PRODUCT C", data: dataSet[2]}],
    chart: {type: "area", stacked: !1, height: 350, zoom: {enabled: !1}, toolbar: {show: !1}},
    dataLabels: {enabled: !1},
    markers: {size: 0},
    fill: {
        type: "gradient",
    ...
    yaxis: {
        labels: {
            style: {colors: "#8e8da4"}, offsetX: 0, formatter: function (e) {
    ...
    xaxis: {
        ...
        labels: {
            rotate: -15, rotateAlways: !0, formatter: function (e, t) {
                return moment(new Date(t)).format("DD MMM YYYY")
            }
        }
    },
    title: {text: "Irregular Data in Time Series", align: "left", offsetX: 14, style: {fontWeight: 500}},
    tooltip: {shared: !0},
    legend: {position: "top", horizontalAlign: "right", offsetX: -10},
    colors: areachartirregularColors
}, (chart = new ApexCharts(document.querySelector("#area_chart_irregular"), options)).render()), (areachartirregularColors = getChartColorsArray("area-missing-null-value")) && (options = {
    series: [{
        name: "Network",
        data: [{x: "Dec 23 2017", y: null}, {x: "Dec 24 2017", y: 44}, {x: "Dec 25 2017", y: 31}, {
            x: "Dec 26 2017",
            y: 38
        }, {x: "Dec 27 2017", y: null}, {x: "Dec 28 2017", y: 32}, {x: "Dec 29 2017", y: 55}, {
            x: "Dec 30 2017",
            y: 51
        }, {x: "Dec 31 2017", y: 67}, {x: "Jan 01 2018", y: 22}, {x: "Jan 02 2018", y: 34}, {
            x: "Jan 03 2018",
            y: null
        }, {x: "Jan 04 2018", y: null}, {x: "Jan 05 2018", y: 11}, {x: "Jan 06 2018", y: 4}, {
            x: "Jan 07 2018",
            y: 15
        }, {x: "Jan 08 2018", y: null}, {x: "Jan 09 2018", y: 9}, {x: "Jan 10 2018", y: 34}, {
            x: "Jan 11 2018",
            y: null
        }, {x: "Jan 12 2018", y: null}, {x: "Jan 13 2018", y: 13}, {x: "Jan 14 2018", y: null}]
    }],
    chart: {type: "area", height: 350, animations: {enabled: !1}, zoom: {enabled: !1}, toolbar: {show: !1}},
    dataLabels: {enabled: !1},
    stroke: {curve: "straight"},
    fill: {opacity: .8, type: "pattern", pattern: {style: ["verticalLines", "horizontalLines"], width: 5, height: 6}},
    markers: {size: 5, hover: {size: 9}},
    title: {text: "Network Monitoring", style: {fontWeight: 500}},
    tooltip: {intersect: !0, shared: !1},
    theme: {palette: "palette1"},
    xaxis: {type: "datetime"},
    yaxis: {title: {text: "Bytes Received"}},
    colors: areachartirregularColors
}, (chart = new ApexCharts(document.querySelector("#area-missing-null-value"), options)).render());
