<!doctype html>
<html lang="en" data-layout="vertical" data-layout-style="detached" data-layout-position="fixed" data-topbar="light" data-sidebar="dark" data-sidebar-size="sm" data-layout-width="fluid" data-sidebar-visibility="show" data-bs-theme="light" data-preloader="disable"><head>

<head>

    <meta charset="utf-8" />
    <title>Dashboard | NC - Admin & Dashboard Template</title>
    ...
    <link rel="stylesheet" href="/buttons/2.2.2/css/buttons.dataTables.min.css">
    ...
    <!-- Doughnut-->
    <link href="/CSS-Progress-Pie-master/css/progress_pie_compiled.css" rel="stylesheet" type="text/css" />

    <link href="/npm/select2%404.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet">

</head>
<body data-new-gr-c-s-check-loaded="14.1143.0" data-gr-ext-installed="" style="background-color: #EAEBE3 !important;" class="twocolumn-panel">
...
<div id="layout-wrapper">
    ...
    <!-- ========== App Menu ========== -->
    <div class="app-menu navbar-menu" style="background-color: #041E43 !important;">
        <!-- LOGO -->
        <div class="navbar-brand-box">
            <!-- Dark Logo-->
            <a href="/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="/images/dark_logo.png" alt="" height="22">
                    </span>
                <span class="logo-lg">
                        <img src="/images/dark_logo.png" alt="" height="17">
                    </span>
            </a>
            <!-- Light Logo-->
            <a href="/" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="/images/light_logo.png" alt="" height="22">
                    </span>
                <span class="logo-lg">
                        <img src="/images/light_logo.png" alt="" height="17">
                    </span>
            </a>
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item d-flex justify-content-center">
                        <a href="/" class="logo logo-dark justify-content-center">
                            <span class="logo-sm"><img src="/images/dark_logo.png" alt="" height="50"></span>
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/transactions" role="button" aria-expanded="false" aria-controls="sidebarApps">
                            <i class="ri-apps-2-line"></i> <span>Transactions</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/payments" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/teamaccounts" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                            <i class="ri-account-circle-line"></i> <span data-key="t-authentication">Team Accounts</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/developerapikey" role="button" aria-expanded="false" aria-controls="sidebarPages">
                            <i class="ri-pages-line"></i> <span data-key="t-pages">Developers API Key</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/ipwhitelisting" role="button" aria-expanded="false" aria-controls="sidebarLanding">
                            <i class="ri-rocket-line"></i> <span data-key="t-landing">IP Whitelisting</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/payout" role="button" aria-expanded="false" aria-controls="sidebarUI">
                            <i class="ri-pencil-ruler-2-line"></i> <span data-key="t-base-ui">PAYOUT HISTORY</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/transfer" role="button" aria-expanded="false" aria-controls="sidebarAdvanceUI">
                            <i class="ri-stack-line"></i> <span data-key="t-advance-ui">Transfer</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/withdraw">
                            <i class="ri-honour-line"></i> <span data-key="t-widgets">Withdraw</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/charges" role="button" aria-expanded="false" aria-controls="sidebarForms">
                            <i class="ri-file-list-3-line"></i> <span data-key="t-forms">Charges</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/others" role="button" aria-expanded="false" aria-controls="sidebarTables">
                            <i class="ri-layout-grid-line"></i> <span data-key="t-tables">Others</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/hppview" role="button" aria-expanded="false" aria-controls="sidebarCharts">
                            <i class="ri-pie-chart-line"></i> <span data-key="t-charts">HPP View</span>
                        </a>
                    </li>
    ...
    <div class="main-content">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <script>document.write(new Date().getFullYear())</script> © NC.
                    </div>
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            Design & Develop by Nard Concepts
                        </div>
                    </div>
                </div>
            </div>
...
<script src="/apexchart-js/stock-prices.js"></script>
<!-- for github style chart -->
<script src="/apexchart-js/github-data.js"></script>
<!-- for irregular timeseries chart -->
<script src="/apexchart-js/irregular-data-series.js"></script>
...
<!--select2 cdn-->
<script src="/npm/select2%404.1.0-rc.0/dist/js/select2.min.js"></script>
