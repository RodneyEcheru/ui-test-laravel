...
<x-layouts.dashboard>
            ...
            <div class="col-12 col-md-8 card-separator">
                ...
                <div class="d-flex justify-content-between flex-wrap gap-3 me-5">
                    <div class="d-flex align-items-center gap-3 me-4 me-sm-0">
                        <span class="bg-label-primary p-2 rounded"><i class='ti ti-device-laptop ti-xl'></i></span>
    ...
    <div class="row">
        <div class="col-8 row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <small class="d-block mb-1 text-muted">Performance Overview</small>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body pb-0">
                        <div class="card-icon"><span class="badge bg-label-success rounded-pill p-2"><i class='ti ti-credit-card ti-sm'></i></span></div>
            ...
            <div class="col-12 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between pb-1">
                        ...
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="totalEarning"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="ti ti-dots-vertical ti-sm text-muted"></i>
                            </button>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            ...
                            <li class="mb-4 pb-1 d-flex justify-content-between align-items-center">
                                <div class="badge bg-label-info rounded p-2"><i
                                        class="ti ti-link ti-sm"></i></div>
                                <div class="d-flex justify-content-between w-100 flex-wrap">
            ...
            <!-- Source Visit -->
            <div class="col-6 order-2 order-lg-1 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="card-title mb-0">
                        ...
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="sourceVisits"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="ti ti-dots-vertical ti-sm text-muted"></i>
                            </button>
                            ...
                            <li class="mb-3 pb-1">
                                <div class="d-flex align-items-start">
                                    <div class="badge bg-label-secondary p-2 me-3 rounded"><i
                                            class="ti ti-shadow ti-sm"></i></div>
        ...
        <div class="col-4">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-grid">
                            <a href="#" class="btn btn-primary rounded-pill">Create Test</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <div class="text-center">
                            <h4 class="mb-1">Scheduled Test</h4>
                            <img src="/assets/img/front-pages/icons/paper-airplane.png" alt="paper airplane icon" class="mb-4 pb-2">
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="d-grid">
                            <a href="#" class="btn btn-primary rounded-pill">Set another</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 mt-3">
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">Overall performance</h5>
                    </div>
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-3 pb-1">
                                ...
                                <div class="row w-100 align-items-center">
                                    <div class="col-9">
                                        <div class="me-2">
                                            <h6 class="mb-2">Practice tests</h6>
                            ...
                            <li class="d-flex mb-3 pb-1">
                                ...
                                <div class="row w-100 align-items-center">
                                    <div class="col-9">
                                        <div class="me-2">
                                            <h6 class="mb-2">Questionaires</h6>
                            ...
                            <li class="d-flex">
                                ...
                                <div class="row w-100 align-items-center">
                                    <div class="col-9">
                                        <div class="me-2">
                                            <h6 class="mb-2">Monthly tests</h6>
                    ...
                    <div class="card-body">
                        <div class="d-grid">
                            <a href="#" class="btn btn-primary rounded-pill">See overall results</a>
                        </div>
                    </div>
                </div>
            </div>
