<x-layout.dashboard>
    ...
    <div class="row">
        <div class="col-4 d-flex flex-row gap-4 mb-4">
            <div class="my-auto fs-20"><strong>Team Accounts</strong></div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-body row">
                    <div class="col-12 mb-4">
                        <div class="flex flex-row justify-content-end">
                            <button type="button" class="btn btn-primary ms-auto rounded-3" style="background-color: #041E43" data-bs-toggle="modal" data-bs-target="#myModal">Add a new user</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary rounded-3" style="background-color: #041E43">Add New User</button>
                                        </div>
