<x-layout.dashboard>
    ...
    <div class="row">
        <div class="col-4 d-flex flex-row gap-4 mb-4">
            <div class="my-auto fs-20"><strong>Transactions</strong></div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-primary ms-auto rounded-3" style="background-color: #041E43">Cash Payment Transaction</button>
                    <button type="button" class="btn btn-secondary ms-auto rounded-3 border-0" style="background-color: #D8E5FF; color: #041E43">Mobile Payment Transaction</button>
                    <button type="button" class="btn btn-secondary ms-auto rounded-3 border-0" style="background-color: #D8E5FF; color: #041E43">Bank Transaction</button>
                </div>
                <div class="card-body row">
                            ...
                            <div class="card-body">
                                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-ordering="false">Merchant Name</th>
                                        <th data-ordering="false">Amount</th>
                                        <th data-ordering="false">Currency</th>
                    ...
                    <div class="col-12">
                        <h3 class="card-title mb-4">Transaction Details</h3>
                        <div class="card rounded-4 border-1">
                            <div class="card-body">
                                        ...
                                        <div class="col-4">
                                            <div class="d-flex flex-column gap-3">
                                                <div>
                                                    ...
                                                    <h5 class="fs-14 my-1"><a href="#" class="text-reset">myname@gmail.com</a></h5>
                                                </div>
                                                <div>
                                        ...
                                        <div class="col-4">
                                            <div class="d-flex flex-column gap-3">
                                                <div>
                                                    ...
                                                    <h5 class="fs-14 my-1"><a href="#" class="text-reset">84E223</a></h5>
                                                </div>
                                                <div>
                                                    <span class="text-muted">Bank Name</span>
                                                    <h5 class="fs-14 my-1"><a href="#" class="text-reset">123 Bank</a></h5>
                                                </div>
                                                <div>
                                                    <span class="text-muted">Email</span>
                                                    <h5 class="fs-14 my-1"><a href="#" class="text-reset">myname@gmail.com</a></h5>
